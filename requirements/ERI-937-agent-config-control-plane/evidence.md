...
| 03B2 结构完整性 | 状态、候选、block-only plan、验收和未决边界同步 | 通过：决策卡 16、独立决策轴 63、03B2 决策节 1、验收场景 1；03C/03D 保持待给方案；`git diff --check` 通过 |
...
- DEC-03C—03D 与 DEC-04—DEC-16 的拍板结果：后续逐项写入 `design.md`。
